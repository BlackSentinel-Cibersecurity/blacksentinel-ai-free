...
provider "registry.terraform.io/hashicorp/aws" {
  ...
  hashes = [
    "h1:TcgYmxfRRrrDl7efg/Tmkh/VCIyAWmKBbhXCWKbMuks=",
...
provider "registry.terraform.io/hashicorp/cloudinit" {
  ...
  constraints = ">= 2.0.0"
  hashes = [
    "h1:oNfrFNk+m2ZEQ882fn4I06tDF97XDeKqdK7OuA1oITo=",
...
provider "registry.terraform.io/hashicorp/helm" {
  ...
  constraints = "~> 2.11"
  hashes = [
    "h1:e02OuIYxtg3TAakHl3x8U+F1oGJHMMaJLZUuw+SGdJk=",
...
provider "registry.terraform.io/hashicorp/kubernetes" {
  ...
  hashes = [
    "h1:5V36Jj9Q6w0QPn0ELJzCnlpWZGV3+OnHuEkPujAKGX4=",
...
provider "registry.terraform.io/hashicorp/time" {
  ...
  constraints = ">= 0.9.0"
  hashes = [
    "h1:IGUK1czVUtAmi0pYMf2xZiKAi1uAXhkOCbfdPdKHj4Q=",
...
provider "registry.terraform.io/hashicorp/tls" {
  ...
  constraints = ">= 3.0.0"
  hashes = [
    "h1:t+OXVT9xJN0xt6l6Nr1rlFZ6JDNExuopxOrlWN3P6C0=",
